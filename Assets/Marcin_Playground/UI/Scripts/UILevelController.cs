...
public class UILevelController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _randomCongratsList = TheraplyHelpers.GenerateNumbers(0, congratAudioClips.Count - 1);
        _randomMorseList = TheraplyHelpers.GenerateNumbers(0, 1, true);
    ...
    IEnumerator GenerateGridPointsCoroutine()
    {
        ...
        grid = new GameObject();
        grid.name = "Grid";
        grid.transform.parent = transform.GetChild(0).transform.GetChild(0);
        yield return null;
