...
namespace Jakub
{
    public class CollisionSound : MonoBehaviour{
        ...
        string _bodyTargetInstanceId = string.Empty;
        string _bodyAppearedAtUtc = string.Empty;
        float _bodyAppearedAtElapsedSec = -1f;
        public string BodyTargetInstanceId => _bodyTargetInstanceId;
        public string BodyAppearedAtUtc => _bodyAppearedAtUtc;
        public float BodyAppearedAtElapsedSec => _bodyAppearedAtElapsedSec;
        ...
        void MarkBodyAppearance()
        {
            _bodyTargetInstanceId = LegacyInteractionTelemetry.CreateTargetInstanceId();
            _bodyAppearedAtUtc = LegacyInteractionTelemetry.CurrentUtcIso();
            _bodyAppearedAtElapsedSec = LegacyInteractionTelemetry.CurrentRealtimeSec();
        }
    }
}
