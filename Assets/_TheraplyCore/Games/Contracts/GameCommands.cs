...
namespace TheraplyCore.Games.Contracts
{
    ...
    public static class GameCommandIds
    {
        ...
        public const string QuestInteractionPreview = "QUEST_INTERACTION_PREVIEW";
    ...
    public sealed class QuestInteractionEventItem
    {
        ...
        public string targetAppearedAtUtc;
        public float targetAppearedAtElapsedSec;
        public float responseSec;
    ...
    [Serializable]
    public sealed class QuestInteractionPreviewPayload
    {
        public string sessionId;
        public string gameRunId;
        public QuestInteractionEventItem @event;
    }
