...
- P6 is now partially started (`R-P6-002`, `R-P6-005`, `R-P6-011` delivered; `R-P6-004` in progress with deterministic simulator state restore); catalog/licensing/full production lifecycle scope remains open.
