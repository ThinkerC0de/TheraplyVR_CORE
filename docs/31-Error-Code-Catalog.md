...
- envelope: `ENVELOPE_*`
- session: `SESSION_LOCK_CONFLICT`, `SESSION_CLOSURE_REQUIRED`, `SESSION_OWNERSHIP_CONFLICT`, `SESSION_OWNERSHIP_MISSING`, `SESSION_NOT_ACTIVE`
...
- package probe telemetry: `PACKAGE_PROBE_*` (`PACKAGE_PROBE_OK`, `PACKAGE_PROBE_DISABLED`, `PACKAGE_PROBE_REQUEST_NOT_ENABLED`, `PACKAGE_PROBE_URI_MISSING`, `PACKAGE_PROBE_URI_INVALID`, `PACKAGE_PROBE_TIMEOUT`, `PACKAGE_PROBE_HTTP_ERROR`, `PACKAGE_PROBE_CONNECTION_ERROR`, `PACKAGE_PROBE_DATA_ERROR`, `PACKAGE_PROBE_REQUEST_FAILED`, `PACKAGE_PROBE_EXCEPTION`)
...
- runtime entitlement gate failures: `START_GAME_GAME_NOT_ENTITLED`, `START_GAME_ENTITLEMENT_PROFILE_UNKNOWN`, `INSTALL_GAME_GAME_NOT_ENTITLED`, `INSTALL_GAME_ENTITLEMENT_PROFILE_UNKNOWN`
